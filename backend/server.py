...
MASTER_KEYS = {"doc_terms": "masters_doc_terms", "payment_terms": "masters_payment_terms",
               ...
               "currency": "masters_currency", "theme": "masters_theme"}
...
# Theme colour. One hex; the frontend derives hover/active/border shades from it.
DEFAULT_THEME = {"hex": "#D1001C", "name": "Blood Orange"}
...
async def get_masters(user=Depends(get_current_user)):
    return {
        ...
        "theme": await _get_setting(MASTER_KEYS["theme"], DEFAULT_THEME),
    }
