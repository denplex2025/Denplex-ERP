...
export default function PurchaseBillCreate() {
  ...
  return (
    <div data-testid="pb-create-page" className="pb-24">
          ...
          <tbody>
            {lines.map((l, i) => (
              <tr key={i} className="border-t border-slate-100">
                ...
                <td className="p-2"><Input list="pb-item-names" value={l.description} onChange={e => pickItem(i, e.target.value)} className="h-8 min-w-[180px]" placeholder="Item or description" /></td>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Fld label="Notes"><Textarea rows={6} value={f.terms_text} onChange={e => set("terms_text", e.target.value)} /></Fld>
