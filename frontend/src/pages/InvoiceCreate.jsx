    ...
    <div data-testid="invoice-create-page" className="pb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="border border-slate-200 rounded-md p-4 space-y-2 text-sm h-fit">
          ...
          <div className="flex justify-between items-center"><span className="text-slate-500">TDS</span><Input type="number" value={f.tds} onChange={e => set("tds", e.target.value)} className="h-8 w-24 text-right" /></div>
